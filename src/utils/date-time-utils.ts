...
export function getUTCDayBoundary(date: Date) {
...
export function toLocaleDate(date: Date, zone: IANATimezone) {
  if (!IANAZone.isValidZone(zone)) {
    throw new Error(`Invalid IANA Olsen Timezone: ${zone}`);
  }
  return toLuxonLocaleData(date, zone).toJSDate();
}

function toLuxonLocaleData(date: Date, zone: IANATimezone) {
